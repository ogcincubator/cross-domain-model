...
`ogc.model.cross-domain.myFeature` *v1.0*
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/cross-domain-model/build/annotated/model/cross-domain/myFeature/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/cross-domain-model/build/annotated/model/cross-domain/myFeature/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/cross-domain-model/build/annotated/model/cross-domain/myFeature/context.jsonld)
